...
function initPreBoucles() {
    addPreBoucle('boucledauthors', 'Pseudos boucled', entityAuthor, true,
        ['vinz', 'tacos', 'aneryl', 'flubus', 'kinahe', 'ambiguite', 'cacadetruire', 'pazeur', 'antoineforum', 'regimeducamp', 'jaxtaylor', 'procaine', 'antigwer', 'ademonstre', 'abbath', 'bobbob', 'croustipeau', 'cigarette', 'cigarrette', 'deratiseur', 'descogentil', 'draco-choc', 'erlinghaland', 'grifforzer', 'gutkaiser', 'hommecoussinet', 'huiledecoude', 'hyiga', 'jirenlechove', 'jvc-censure', 'jyren', 'kaguya', 'kane', 'danmartin', 'kaitokid', 'kiwayjohansson', 'krimson', 'ptitcieux', 'stopcensure', 'galacticwars', 'cimerrisitas', 'supernominateur', 'wohaha', 'zeroavenir', 'windowsbot', 'ylliade', 'mirainikki', 'leao', 'oael', 'surk', 'zemmourfinito', 'labelconfort', 'xinoz', 'zinzinabbath', 'rifson', 'garfield', 'qwertyofficial', 'vcxn', 'kallyuga', '[raven-_]', 'cub*t*mp', 'tub*dut*mp', 'cubedeletan', 'vulvedutemp', 'pubdutemp', 'cubeduclan', 'cubedurang', 'cubedutime', 'clandutube', 'boucleur', 'chouffomoting', 'pleinsdennuis', 'discord-gg-jvc', 'tc1873blanco', 'johny-wu', 'toyaf', 'troglonaute', 'jvxn', 'jvcxn', 'jvcartxna', 'bhlc13h18', 'puissancedekhey', 'micah-bell', 'kmselection', 'arrowheads', 'freepop', 'lionseducteur', 'poechips', 'princessebean', 'stopbanent', 'espiruto', 'cubarobusto', 'storev2', 'maikolinge', 'sanarik', 'encorebanni', 'gilbert733513', 'lydens', 'lionseul', 'lionseducteur', 'yarienapres4', 'timident', 'lionbanni', 'liondoux', 'lionancestral', 'cubemalgache', 'charle*auvet', 'nastyanass', 'op_tiffany', 'avortax3000', 'mikey3000', 'maleau', 'maieau', 'stopbanboucled']);
