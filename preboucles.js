...
function initPreBoucles() {
    ...
    addPreBoucle('kj', 'Kikoo-Japs', entityAuthor, false,
        ['kj', 'trap', 'feet', 'waifu', '-nancy-tomoe', '-pazifion-', '[arnak]', '[nft]', '[pink]panther', '[raven-_]', 'aaaarumi', 'aaargh_0knuckle', 'akambi', 'aleatoire423', 'aniviathefrozen', 'asnium', 'asniumbandant', 'ass2trefle', 'bakjou', 'bbclove', 'beckycringeintp', 'botanica', 'celestinhoiii', 'charlesbuk', 'cheuns', 'chucklaplante', 'chunchunmaru', 'chxrlotte', 'dankie', 'deadwapanese', 'deratisubuleryl', 'dqasdqdsqsdv', 'e-n-a', 'ecrevisse6', 'el_citrone', 'elilalilalulu', 'euhpile', 'evabien', 'femboy', 'fiondekyoko', 'fragiluxur', 'gallys7', 'gamonstrebanni', 'gawr_gura', 'germanqueen', 'gio849', 'gockwach', 'goiemique', 'gommeblanc', 'guiguifdp', 'haruko_', 'heimtathurs', 'hunterjahimees', 'hyacinthos', 'icefairy', 'incel2sur10ette', 'inostranet', 'izumi_sagiri', 'jailedroibordel', 'jean_yahya', 'jeunessehonneur', 'jiva-chan', 'johanneslekhey', 'jteclaquelcul', 'jus_2_beat', 'kai-kod', 'kikoojapsordide', 'kiyoe', 'komisan', 'labynocle', 'lalena', 'lastingchild', 'le*nettoyeur', 'lenticulaire', 'lighthalzen', 'lisabp', 'lizslennus', 'lorkhaj89', 'lostwar', 'luna-blu', 'lysae', 'maeligg', 'maneirei', 'maneiret', 'margie_pkmn', 'marreduban', 'melkhor-dono', 'meowni', 'millefi', 'minatohiraishi', 'minseo', 'misakino_kukuru', 'missmonochrome', 'mister_swing', 'mxthy', 'nettoyeur2gland', 'nysaee', 'parars', 'pasteque_bannie', 'pollorico', 'pomer', 'porteduforum', 'raie-menthalo', 'ranze', 'ranzette', 'raven-50', 'reacriz', 'rimurutempest-', 'rinesa1', 'riokanol', 'ronisiaa', 'shillzificator', 'shintamaru', 'slimeti2', 'solio', 'soup71_', 'sruoxo', 'steinhausen', 'superoksuper', 'supertemmies', 'teslakite', 'thehatkid', 'tobiichi', 'toyaf', 'uwo', 'violeteverdeen', 'vivrayman3', 'waifupeach', 'wepper', 'whitepantyhose', 'xeenay', 'yameyakuna', 'yhria', 'ylliade', 'yojong', 'yoshi_v', 'yoshiyosh_', 'yumiaaaa', 'zerotwo-', 'esclave_ankha']);

    addPreBoucle('popularboucles', 'Boucles connues', entitySubject, true,
        ['ces photos putain', 'yannick*tour eiffel', 'metisseur22cm', 'midsommar', 'eau*pasteque', 'celestin tu', 'l\'échéance est tombée', 'ai-je l\'air sympathique', 'pour avoir une copine en', 'no jump', 'john cena*mort', 'john cena*victime', 'par le corps masculin', 'dicaprio au lidl', '2 sauces interdites', 'allemand fou detruit son clavier', 'ma caissiere', 'traduisez en anglais', 'sauce sonic', 'seth gueko', 'gros gamos allemand', 'eau blanche', 'sss sache que', 'genre de mec plait', 'dwayne johnson', 'charles auvet', 'now cum', 'let\'s fucking go', 'boule blanche dans la mozarella', 'crocodile chelou', 'forumeur le plus eclatax', 'galet de poche', 'kebab breton', 'des chances font du bruits et foutent le bordel', 'femmes vulgaires au lit', 'rockeuse dans l\'âme', 'pris une audi a1', 'fortune d\'arthur', 'renault sort son', 'japonaise*cave*93', 'embauché chez microsoft', 'chié durant l\'accouchement', 'reddit entier sur un mmo', 'rizantrasse', 'chinois dans un wok', 'ans de spam sur le 18-25', 'gamecube est la pire console', 'famille bourgeoise est incroyable', '300 jeux switch', 'je suis web dev', 'lara croft en legging', 'm\'avez vous déjà vu']);
    ...
    addPreBoucle('deviant', 'Déviances', entitySubject, false,
        ['feet*', 'trap*', 'kj', 'adf', 'papa du forum', 'blacked', 'cuck', 'reine fatima', 'reine popo', 'shemale*', 'domina', 'fetichiste', 'fetichisme', 'mym', 'onlyfan', 'onlyfans', 'sissy*', 'trans', 'transexuel', 'transexuelle', 'lgbt*', 'm2f', 'f2m', 'asmr', 'trav', 'travelo', 'femdom', 'cage de chastete', 'rimjob', 'chaturbate', 'salazar', 'sugar daddy', 'woodman', 'waifu', 'moneyslave', 'bbc', 'plug anal', 'edging', 'femboy', 'desu', 'desu~', ':desu:', 'twink']);
