...
function addPreBoucle(id, title, type, entities) {
    const preBoucle =
    {
        id: id,
        title: title,
...
function initPreBoucles() {
    addPreBoucle('boucledauthors', 'Pseudos boucled', entityAuthor,
    ...
    addPreBoucle('popularboucles', 'Boucles connues', entitySubject,
    ...
    addPreBoucle('covid19', 'Covid19', entitySubject,
    ...
    addPreBoucle('politic', 'Politique', entitySubject,
    ...
    addPreBoucle('deviant', 'Déviances', entitySubject,
        ['feet*', 'trap*', 'kj', 'adf', 'papa du forum', 'blacked', 'cuck', 'reine fatima', 'shemale*', 'domina', 'fetichiste', 'fetichisme', 'mym', 'onlyfan', 'onlyfans', 'sissy*', 'trans', 'transexuel', 'transexuelle', 'lgbt*', 'm2f', 'f2m', 'asmr', 'trav', 'travelo', 'femdom', 'cage de chastete', 'rimjob', 'chaturbate', 'salazar']);

    addPreBoucle('socials', 'Réseaux sociaux', entitySubject,
    ...
    addPreBoucle('youtube', 'Youtube', entitySubject,
        ['youtube', 'feldup', 'norman', 'cyprien', 'natoo', 'kemar', 'jdg', 'joueur du grenier', 'amixem', 'squeezie', 'rire jaune', 'kevin tran', 'michou', 'mcfly', 'carlito', 'inoxtag', 'seblafrite', 'joyca', 'julien chieze', 'kyan khojandi', 'lena situations', 'charlie danger', 'florianonair', 'bench', 'bigflo', 'corda', 'fastgoodcuisine', 'julia', 'otaku', 'papacito', 'stephane edouard']);

    addPreBoucle('kiddy', 'Immature', entitySubject,
        ['reacprout*', 'prout', 'caca', 'cacaprout', 'pipi', 'chibrax', 'post ou', 'postoo', 'pose toucan']);

    addPreBoucle('hatred', 'Haineux', entitySubject,
        ['facho*', 'chofs', 'chofa*', 'qlf', 'paz', 'pazification', 'pazifie', 's2s', 'gwer*', 'raciste*', 'hagar', 'hagra', '🐊', 'bassem', 'sadek']);

    addPreBoucle('girls', 'Femmes', entitySubject,
    ...
    addPreBoucle('rap', 'Rap', entitySubject,
    ...
    addPreBoucle('porn', 'Pornographie', entitySubject,
