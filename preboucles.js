...
function initPreBoucles() {
    ...
    addPreBoucle('kj', 'Kikoo-Japs', entityAuthor, false,
        ['kj', 'trap', 'feet', 'waifu', '-nancy-tomoe', '-pazifion-', '[arnak]', '[nft]', '[pink]panther', '[raven-_]', 'aaaarumi', 'aaargh_0knuckle', 'akambi', 'aleatoire423', 'aniviathefrozen', 'asnium', 'asniumbandant', 'ass2trefle', 'bakjou', 'bbclove', 'beckycringeintp', 'botanica', 'celestinhoiii', 'charlesbuk', 'cheuns', 'chucklaplante', 'chunchunmaru', 'chxrlotte', 'dankie', 'deadwapanese', 'deratisubuleryl', 'dqasdqdsqsdv', 'e-n-a', 'ecrevisse6', 'el_citrone', 'elilalilalulu', 'esclave_ankha', 'euhpile', 'evabien', 'femboy', 'fiondekyoko', 'fragiluxur', 'furumia', 'gallys7', 'gamonstrebanni', 'gawr_gura', 'germanqueen', 'gio849', 'gockwach', 'goiemique', 'gommeblanc', 'guiguifdp', 'haruko_', 'heimtathurs', 'hunterjahimees', 'hyacinthos', 'icefairy', 'incel2sur10ette', 'inostranet', 'izumi_sagiri', 'jailedroibordel', 'jean_yahya', 'jeunessehonneur', 'jiva-chan', 'johanneslekhey', 'jteclaquelcul', 'jus_2_beat', 'kai-kod', 'kikoojapsordide', 'kiyoe', 'komisan', 'labynocle', 'lalena', 'lastingchild', 'le*nettoyeur', 'lenticulaire', 'lighthalzen', 'lisabp', 'lizslennus', 'lorkhaj89', 'lostwar', 'luna-blu', 'lysae', 'maeligg', 'maneirei', 'maneiret', 'margie_pkmn', 'marreduban', 'melkhor-dono', 'meowni', 'millefi', 'minatohiraishi', 'minseo', 'misakino_kukuru', 'missmonochrome', 'mister_swing', 'mxthy', 'nettoyeur2gland', 'nysaee', 'parars', 'pasteque_bannie', 'pollorico', 'pomer', 'porteduforum', 'pougo', 'raie-menthalo', 'ranze', 'ranzette', 'raven-50', 'reacriz', 'rimurutempest-', 'rinesa1', 'riokanol', 'ronisiaa', 'shillzificator', 'shintamaru', 'slimeti2', 'solio', 'soup71_', 'sruoxo', 'steinhausen', 'superoksuper', 'supertemmies', 'teslakite', 'thehatkid', 'tobiichi', 'toyaf', 'tropfandetoi', 'uwo', 'violeteverdeen', 'vivrayman3', 'waifupeach', 'wepper', 'whitepantyhose', 'xeenay', 'yameyakuna', 'yhria', 'ylliade', 'yojong', 'yoshi_v', 'yoshiyosh_', 'yumiaaaa', 'zerotwo-']);
...
function initShadowent() {
    const preShadowent = ['U3RvbmVHaWFudA==', 'QW5lcnls', 'Rmx1YnVz', 'bGVhbw==', 'dmlueg==', 'dGFjb3M=', 'a2luYWhl', 'TGVzWWV1eER1Rm9ydW0=', 'Y2lnYXJldHRl', 'd2luZG93c2JvdA==', 'YXJlbnls', 'emVtb3Vyb2lkZQ==', 'amVmYWlzdW5saXZl'];
