...
function initPreBoucles() {
    ...
    addPreBoucle('kj', 'Kikoo-Japs', entityAuthor, false,
        ['kj', 'kikoojap', 'kaji', 'kajy', 'trap', 'feet', 'waifu', 'kawai', 'sissy', 'crucifist01', '_rsaaidesoutien', '-pazifion-', '[arbitraire]', '[aleatoire]', '[arnak]', '[nft]',
            ...
            'deadwapanese', 'deratisubuleryl', 'dokurorider', 'dqasdqdsqsdv', 'dqddqeaededzea', 'draco-choc', 'e-n-a', 'ecrevisse6', 'ecrevisse10', 'el_citrone', 'elementarydesu',
            ...
            'inostranet', 'itoshirin', 'izumi_sagiri', 'jailedroibordel', 'jean_yahya', 'jeunessehonneur', 'jiva-chan', 'johanneslekhey', 'jteclaquelcul', 'jus_2_beat', 'jyren',
            'kane', 'kawashimaurara', 'kesshouban', 'khaaal', 'kikoojapfangeux', 'kikoojapsordide', 'kirakira_', 'kiyoe', 'klaosuen', 'komisan', 'kyokotoshino', 'labynocle', 'laffey',
            ...
            'riokanol', 'ronisiaa', 'sahary', 'sakuta', 'sashimimaruu', 'secalydesudesu', 'sereineptiote', 'sereine', 'sinfulweeb', 'shillzificator', 'shintamaru', 'slimeti2',
    ...
    addPreBoucle('porn', 'Pornographie', entitySubject, false,
        ['porn*', 'p0rn*', 'pron', 'blacked', 'mym', 'onlyfan', 'onlyfans', 'rimjob', 'chaturbate', 'abigail mac', 'addie andrews', 'agatha vega', 'aidra fox', 'aletta ocean',
            ...
            'bbc', 'valentina nappi', 'angela white', 'alex clark']);
