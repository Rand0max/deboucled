...
const storage_announcement_displayed = 'deboucled_announcement14_displayed', storage_announcement_displayed_default = false;
...
const storage_optionDisplayDecensuredWidget = 'deboucled_optionDisplayDecensuredWidget', storage_optionDisplayDecensuredWidget_default = true;
const storage_optionEnableDecensuredChat = 'deboucled_optionEnableDecensuredChat', storage_optionEnableDecensuredChat_default = true;
const storage_optionEnableChatReactions = 'deboucled_optionEnableChatReactions', storage_optionEnableChatReactions_default = true;
const storage_optionEnableForumReactions = 'deboucled_optionEnableForumReactions', storage_optionEnableForumReactions_default = true;
const storage_decensuredLastPing = 'deboucled_decensuredLastPing';
const storage_deboucled_decensuredPingFailures = 'deboucled_decensuredPingFailures';
const storage_decensuredLastStatsLoad = 'deboucled_decensuredLastStatsLoad';
const storage_decensuredOnlineCount = 'deboucled_decensuredOnlineCount';
